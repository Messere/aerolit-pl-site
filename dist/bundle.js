...
"use strict";function macarena(n,e,a=5400){const r=["Macarena\n    o\n   .|.\n    /\\","acarena \n    o\n   \\|.\n    >\\\n","carena M\n    o\n   \\|/\n   /<\n","arena Ma\n    o\n    //\n    >\\\n","rena Mac\n    o\n    X\n   /<\n","ena Maca\n   <o\n    \\\n    >\\\n","na Macar\n   <o>\n    |\n   /<\n","a Macare\n    o>\n   <|\n    >\\\n"," Macaren\n    o\n   <|>\n   /<\n"];let t=0;const o=setInterval(()=>{e.clear(),e.printLn(r[t]),++t>=r.length&&(t=0)},200);return Promise.resolve(null).then(()=>new Promise(n=>setTimeout(n,a))).then(()=>{clearInterval(o)})}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=macarena;

},{}],3:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const CatCommand_1=require("./CatCommand"),CdCommand_1=require("./CdCommand"),ClearCommand_1=require("./ClearCommand"),FileCommand_1=require("./FileCommand"),FortuneCommand_1=require("./FortuneCommand"),HelpCommand_1=require("./HelpCommand"),LsCommand_1=require("./LsCommand"),PsCommand_1=require("./PsCommand"),PwdCommand_1=require("./PwdCommand"),RmCommand_1=require("./RmCommand"),RmdirCommand_1=require("./RmdirCommand"),UnameCommand_1=require("./UnameCommand"),WgetCommand_1=require("./WgetCommand"),WhoamiCommand_1=require("./WhoamiCommand");class BuiltInCommands{constructor(m,e,a){this.help=new HelpCommand_1.default(this),this.ls=new LsCommand_1.default(m),this.pwd=new PwdCommand_1.default(m),this.cd=new CdCommand_1.default(m),this.cat=new CatCommand_1.default(m),this.file=new FileCommand_1.default(m),this.rm=new RmCommand_1.default(m),this.rmdir=new RmdirCommand_1.default(m),this.clear=new ClearCommand_1.default,this.uname=new UnameCommand_1.default(e),this.ps=new PsCommand_1.default(e,a),this.fortune=new FortuneCommand_1.default,this.whoami=new WhoamiCommand_1.default,this.wget=new WgetCommand_1.default(m)}}exports.default=BuiltInCommands;

},{"./CatCommand":4,"./CdCommand":5,"./ClearCommand":6,"./FileCommand":8,"./FortuneCommand":9,"./HelpCommand":10,"./LsCommand":11,"./PsCommand":12,"./PwdCommand":13,"./RmCommand":14,"./RmdirCommand":15,"./UnameCommand":16,"./WgetCommand":17,"./WhoamiCommand":18}],4:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});class LsCommand{constructor(e){this.fileSystem=e}showHelp(e){e.printLn("ls - list contents of current directory")}execute(e,t){if(!this.fileSystem.exists(e[0]||null))return void t.printLn(`ls: cannot access '${e[0]}': No such file or directory`);const s=this.fileSystem.getFile(e[0]||null);if(s.isDir){const e=s.getContents();for(const s of Object.keys(e))this.printFileName(e[s],t)}else this.printFileName(s,t)}printFileName(e,t){t.printLn(e.name,this.getFileClassName(e))}getFileClassName(e){return e.isDir?"file-dir":e.isExecutable?"file-executable":""}}exports.default=LsCommand;

},{}],12:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});class PsCommand{constructor(e,t){this.uaParser=e,this.uptime=t}showHelp(e){e.printLn("ps - show process information")}execute(e,t){const s=this.uptime.getUptimeAsString(),r=`${this.uaParser.getBrowser().name} ${document.location.href}`;t.printLn("PID     TIME CMD"),t.printLn(`  1 ${s} ${r}`)}}exports.default=PsCommand;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const TextFileNode_1=require("../File/TextFileNode");class WgetCommand{constructor(e){this.fileSystem=e}showHelp(e){e.printLn("wget <url>       - retrieve and print url contents"),e.printLn("wget <url> <file - retrieve url contents and save it to file"),e.printLn("Note that cross origin request restrictions apply.")}execute(e,t){const i=this.validateArgs(e);if(i.valid)return fetch(i.url).then(e=>e.text()).then(e=>{i.saveToFile?this.saveTextFile(i.dir,i.name,e):t.printLn(e)}).catch(e=>{t.printLn(e)});t.printLn(`wget: ${i.errorMessage}`)}saveTextFile(e,t,i){const s=new TextFileNode_1.default(t,i);this.fileSystem.add(e,s)}validateArgs(e){const t=e[0]||null,i=e[1]||null,s={saveToFile:!1,url:t,valid:!1};if(null===t)s.errorMessage="missing url";else if(null!==i&&this.fileSystem.exists(i))s.errorMessage=`${i} already exists`;else if(null!==i){const e=i.split(this.fileSystem.directorySeparator),t=e.pop(),r=this.fileSystem.directorySeparator+e.join(this.fileSystem.directorySeparator);if(this.fileSystem.exists(r)){this.fileSystem.getFile(r).isDir?(s.valid=!0,s.saveToFile=!0,s.dir=r,s.name=t):s.errorMessage=`${r}: is not a directory`}else s.errorMessage=`${i}: invalid path`}else s.valid=!0;return s}}exports.default=WgetCommand;

},{"../File/TextFileNode":22}],18:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});class SimpleTerminal{constructor(t,i,n){this.errorCount=0,this.maxErrorCount=100,this.prompt=t,this.terminal=n,this.commandLineParser=i}print(t,i){this.terminal.print(t,i)}printLn(t,i){this.terminal.printLn(t,i)}input(t){this.terminal.input(this.prompt.getPrompt(),t)}renderTo(t){t.appendChild(this.terminal.html)}start(){this.handleCommandLine(null)}clear(){this.terminal.clear()}handleException(t){if(this.printLn(""),this.printLn(t.message,"error"),this.errorCount++,!(this.errorCount<this.maxErrorCount))throw new Error("Too many errors, aborting");this.handleCommandLine(null)}handleCommandLine(t){try{if(this.printLn(""),null!==t&&""!==t.trim()){const i=this.commandLineParser.handle(t)(this);void 0===i?this.input(this.handleCommandLine.bind(this)):i.then(()=>{this.input(this.handleCommandLine.bind(this))})}else this.input(this.handleCommandLine.bind(this))}catch(t){this.handleException(t)}}}exports.default=SimpleTerminal;

},{}],25:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});class Terminal{constructor(){this.firstPrompt=!0,this.html=document.createElement("div"),this.html.className="Terminal",this.innerWindow=document.createElement("div"),this.output=document.createElement("p"),this.inputLine=document.createElement("span"),this.cursor=document.createElement("span"),this.inputElement=document.createElement("p"),this.inputElement.appendChild(this.inputLine),this.inputElement.appendChild(this.cursor),this.innerWindow.appendChild(this.output),this.innerWindow.appendChild(this.inputElement),this.html.appendChild(this.innerWindow),this.setBackgroundColor("black"),this.setTextColor("white"),this.setTextSize("1em"),this.setWidth("100%"),this.setHeight("100%"),this.html.style.fontFamily="Monaco, Courier",this.html.style.margin="0",this.innerWindow.style.padding="10px",this.inputElement.style.margin="0",this.output.style.margin="0",this.output.style.display="inline",this.cursor.style.background="white",this.cursor.innerHTML="C",this.cursor.style.display="none",this.inputElement.style.display="none"}print(t,e){const i=this.makeNewLine(t,e);i.style.display="inline",this.output.appendChild(i)}printLn(t,e){const i=this.makeNewLine(t,e);this.output.appendChild(i)}input(t,e){const i=document.createElement("input");i.style.position="absolute",i.style.zIndex="-100",i.style.outline="none",i.style.border="none",i.style.opacity="0",i.style.fontSize="0.2em",this.inputLine.textContent="",this.inputElement.style.display="inline-block",this.html.appendChild(i),this.fireCursorInterval(i),t.length&&this.print(t,"prompt"),i.onblur=(()=>{this.cursor.style.display="none"}),i.onfocus=(()=>{i.value=this.inputLine.textContent,this.cursor.style.display="inline"}),this.html.onclick=(()=>{i.focus()}),i.onkeydown=(t=>{37===t.which||39===t.which||38===t.which||40===t.which||9===t.which?t.preventDefault():13!==t.which&&setTimeout(()=>{this.inputLine.textContent=i.value},1)}),i.onkeyup=(t=>{if(13===t.which){this.inputElement.style.display="none";const t=i.value;this.print(t),this.html.removeChild(i),"function"==typeof e&&e(t)}}),this.firstPrompt?(this.firstPrompt=!1,setTimeout(()=>{i.focus()},50)):i.focus()}clear(){this.output.innerHTML=""}setTextSize(t){this.output.style.fontSize=t,this.inputElement.style.fontSize=t}setTextColor(t){this.html.style.color=t,this.cursor.style.background=t}setBackgroundColor(t){this.html.style.background=t}setWidth(t){this.html.style.width=t}setHeight(t){this.html.style.height=t}makeNewLine(t,e){const i=document.createElement("div");return e&&(i.className=e),i.textContent=t,i}fireCursorInterval(t){setTimeout(()=>{t.parentElement&&(this.cursor.style.visibility="visible"===this.cursor.style.visibility?"hidden":"visible",this.fireCursorInterval(t))},500)}}exports.default=Terminal;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const ua_parser_js_1=require("ua-parser-js"),BuiltInCommands_1=require("../Command/BuiltInCommands"),CommandLineParser_1=require("../Command/CommandLineParser"),InMemoryFileSystem_1=require("../FileSystem/InMemoryFileSystem"),PromptWithCwd_1=require("../Prompt/PromptWithCwd"),SimpleTerminal_1=require("../Terminal/SimpleTerminal"),Terminal_1=require("../Terminal/Terminal"),Uptime_1=require("../Uptime/Uptime"),files_1=require("./files"),fileSystem=new InMemoryFileSystem_1.default(files_1.default),prompt=new PromptWithCwd_1.default(fileSystem,"aerolit.pl [","]$ "),uaParser=new ua_parser_js_1.UAParser,uptime=new Uptime_1.default(Date.now()),commands=new BuiltInCommands_1.default(fileSystem,uaParser,uptime),commandLineParser=new CommandLineParser_1.default(commands,fileSystem),terminal=new SimpleTerminal_1.default(prompt,commandLineParser,new Terminal_1.default);document.getElementById("main").innerHTML="",terminal.renderTo(document.getElementById("main")),terminal.start();

},{"../Command/BuiltInCommands":3,"../Command/CommandLineParser":7,"../FileSystem/InMemoryFileSystem":19,"../Prompt/PromptWithCwd":23,"../Terminal/SimpleTerminal":24,"../Terminal/Terminal":25,"../Uptime/Uptime":26,"./files":29,"ua-parser-js":1}],29:[function(require,module,exports){
