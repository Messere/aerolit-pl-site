...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});class CatCommand{constructor(t){this.fileSystem=t}showHelp(t){t.printLn("cat <file> - show contents of the <file>")}execute(t,e){const s=t[0]||null;if(null===s)e.printLn("cat: missing operand");else if(this.fileSystem.exists(s)){const t=this.fileSystem.getFile(s);t.isDir?e.printLn(`cat: ${s}: Is a directory`):e.printLn(t.getContents().toString())}else e.printLn(`cat: ${s}: No such file or directory`)}}exports.default=CatCommand;
...
},{"../FileSystem/InMemoryFileSystem":17,"../Location/DocumentLocation":21,"../Parser/CommandLineParser":22,"../Prompt/PromptWithCwd":23,"../Terminal/SimpleTerminal":24,"../Terminal/Terminal":25,"../Uptime/Uptime":26,"./BuiltInCommands":29,"./Files":30,"ua-parser-js":1}],29:[function(require,module,exports){
