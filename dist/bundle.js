...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const CatCommand_1=require("./CatCommand"),CdCommand_1=require("./CdCommand"),ClearCommand_1=require("./ClearCommand"),FileCommand_1=require("./FileCommand"),FortuneCommand_1=require("./FortuneCommand"),HelpCommand_1=require("./HelpCommand"),LsCommand_1=require("./LsCommand"),PsCommand_1=require("./PsCommand"),PwdCommand_1=require("./PwdCommand"),RmCommand_1=require("./RmCommand"),RmdirCommand_1=require("./RmdirCommand"),UnameCommand_1=require("./UnameCommand"),WgetCommand_1=require("./WgetCommand"),WhoamiCommand_1=require("./WhoamiCommand");class BuiltInCommands{constructor(m,e,a,d){this.help=new HelpCommand_1.default(this),this.ls=new LsCommand_1.default(m),this.pwd=new PwdCommand_1.default(m),this.cd=new CdCommand_1.default(m),this.cat=new CatCommand_1.default(m),this.file=new FileCommand_1.default(m),this.rm=new RmCommand_1.default(m),this.rmdir=new RmdirCommand_1.default(m),this.clear=new ClearCommand_1.default,this.uname=new UnameCommand_1.default(e),this.ps=new PsCommand_1.default(e,a,d),this.fortune=new FortuneCommand_1.default,this.whoami=new WhoamiCommand_1.default,this.wget=new WgetCommand_1.default(m)}}exports.default=BuiltInCommands;
