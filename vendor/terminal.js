...
var Terminal = (function () {
	...
	var TerminalConstructor = function (id) {
        ...
        const makeNewLine = function(message, className) {
		...
		this.print = function (message, className) {
            const newLine = makeNewLine(message, className);
            newLine.style.display = 'inline';
			this._output.appendChild(newLine)
		}

		this.printLn = function (message, className) {
            const newLine = makeNewLine(message, className);
			this._output.appendChild(newLine)
		}
        ...
        this._output.style.display = 'inline';
